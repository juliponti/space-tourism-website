...
function Navigation() {
  return (
    <nav className="bg-[#ffffff08] backdrop-blur-lg absolute top-0 right-0 h-24 w-[830px] hidden sm:hidden md:flex md:w-96 lg:flex">
      <div className="h-0.5 w-[473px] border border-white absolute opacity-25 -left-[440px] top-12 z-10 md:hidden"></div>
